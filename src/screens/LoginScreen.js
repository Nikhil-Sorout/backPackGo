...
const LoginScreen = () => {
    ...
    return (
        <SafeAreaView className='flex-1 bg-gray-100 '>
            <View className='justify-center items-center bg-white p-2 rounded-3xl'>
            ...
            /> */}
                ...
                <TouchableOpacity className='bg-[#7563F6] px-4 py-4 rounded-xl w-36'>
                    <Text className='text-center text-white font-semibold'>LOG IN</Text>
                </TouchableOpacity>
                <Text className='text-[#7563F6] font-bold text-center'>FORGOT PASSWORD ?</Text>
                </View>
            ...
            <View className='flex justify-center items-center gap-4 p-4 '>
                <AntDesign name='minus' size={30} color={"red"} />
                    ...
                    <Text className='text-[#7563F6] font-semibold'>Don't Have An Account?</Text>
                    <TouchableOpacity onPress={()=>Navigation.navigate('SignUpScreen')} className='w-28 bg-[#A0FBE6] py-2 px-4 rounded-xl'>
                        <Text className='text-center font-bold opacity-60'>SIGN UP</Text>
                    </TouchableOpacity>
            
                <Text className='text-gray-400'>Or Log In With</Text>
                <TouchableOpacity>
